...
public class DetailProduk extends AppCompatActivity {
    ...
    private TextView txtstok, txtberat;
...
//    String qty;
    ...
    private int stok, harga, jml_terjual, berat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtberat = (TextView) findViewById(R.id.tv_berat_detail);
        ...
        getDetail.enqueue(new Callback<ResponseShowDetail>() {
            ...
            public void onResponse(Call<ResponseShowDetail> call, Response<ResponseShowDetail> response) {
                ...
                if (pesan.equals("BERHASIL")) {
                    ...
                    txtberat.setText(String.valueOf(berat) + " gr");
                    setTitle(barang);
